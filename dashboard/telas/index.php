...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../telas/');
//*** FIN  ****/
...
$cadRef 	= $serviciosFunciones->devolverSelectBox($resTipoTramado,array(1),'');
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerTelas(),7);
    	...
    	<div class="cuerpoBox">
        	...
        	<div class='row' style="margin-left:25px; margin-right:25px;">
            	<div class="alert alert-info">
                	<p><span class="glyphicon glyphicon-info-sign"></span> Recuerde que las medidas seran expresadas en centimetros</p>
                </div>
            </div>
