...
--
-- Servidor: localhost
-- Tiempo de generación: 15-11-2016 a las 10:57:04
...
CREATE TABLE IF NOT EXISTS `tbresiduos` (
  ...
  `roller` smallint(6) NOT NULL,
  `telaancho` smallint(6) NOT NULL,
  `telaalto` smallint(6) NOT NULL,
  `zocalo` smallint(6) NOT NULL,
